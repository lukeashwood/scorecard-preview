...
export const EDITORIAL: Record<string, Editorial> = {
  ...
  electricity: { group: 'condition', influence: 'shared', better: 'lower', labels: ['Original', 'Price index incl. rebates'], supports: 'power_bills', influenceNote: 'Shared with the states and the market. Government rebates lower the measured price while they last.' },
  wholesale_gas: { group: 'condition', influence: 'shared', better: 'lower', labels: ['Nominal'], influenceNote: 'Set mainly by world energy markets. The federal price cap and gas code introduced in December 2022 also apply.' },
  mortgage: { group: 'condition', influence: 'indirect', better: 'lower', labels: ['Nominal'], supports: 'interest_rates', influenceNote: 'Follows the Reserve Bank’s cash rate, which the government does not set.' },
  interest_rates: { group: 'condition', influence: 'indirect', better: 'none', dropContext: [/adds to demand/i], betterNote: 'A higher or lower cash rate is a tool, not a goal, so its direction isn’t coloured.', labels: ['Policy rate'], influenceNote: 'Set by the independent Reserve Bank board, not by the government.' },
  ...
  unemployment: { group: 'condition', influence: 'indirect', better: 'lower', dropContext: [/concentrated in publicly funded/i], labels: ['Seasonally adjusted'], influenceNote: 'Follows the business cycle and Reserve Bank policy more than any single federal decision.' },
  ...
  productivity: { group: 'condition', influence: 'indirect', better: 'higher', labels: ['Seasonally adjusted', 'Real'], influenceNote: 'Depends on business investment, technology and skills over many years. Policy matters, slowly.' },
  insolvencies: { group: 'condition', influence: 'indirect', better: 'lower', labels: ['Financial-year totals'], unitOverride: 'companies', influenceNote: 'Follows interest rates, costs and demand. The ATO’s debt-collection stance, a federal lever, also matters.' },
